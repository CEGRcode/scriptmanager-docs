...
<div class="tutorial-img-flow-container" style={{ textAlign: 'center' }}>
  <img src={require('./img/Atac-Seq_heatmap.png').default} style={{width:20+'%',}}/>
...
### 8. Label your Saved PNG Heatmap

#### 8.1. Navigate to Figure Generation ➡️ [__Label Heatmaps__][label-heatmap] so we can add axes to the heatmap
...
#### 8.2. Optionally type text into the fields to annotate your axes (Or leave them empty to just generate an SVG border)

<div class="tutorial-img-flow-container">
  <img src={require('./img/gui-labelhm2.png').default} style={{width:40+'%',}}/>
  <i class="fa-solid fa-arrow-right fa-lg"></i>
  <img src={require('./img/gui-labelhm-dialog.png').default} style={{width:40+'%',}}/>
</div>


#### 8.3. Click "Generate" to create an SVG file that labels your PNG
...
java -jar $SCRIPTMANAGER figure-generation label-heatmap $OUTPUT\_heatmap.png \
  -x "GRCh8" -y "GRCh8_knownGene Primary Sites" -l -125 -m 0 -r +125 -o $OUTPUT\_heatmap.svg
