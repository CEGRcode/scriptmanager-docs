...
<Link
  ...
  href="file:///Users/alimadeen/Downloads/UCSC_GRCh38_knownGene_GENCODEV3_ALL-TSS_2000bp.bed">
...
#### 5.3. Select "Full Fragment", "Combined" color , "Output Composite", "CDT", and "Output GZIP". Then, select "Output Directory".
...
<div class="tutorial-img-flow-container">
  <img src={require('./img_atacseq/loadbed:bam.png').default} style={{width:60+'%',}}/>
</div>


#### 6.3. Change Expansion Size to 1000 from Center 
<div class="tutorial-img-flow-container">
  <img src={require('./img_atacseq/bed+cdt_expansion.png').default} style={{width:60+'%',}}/>
</div>

#### 6.4. Select Base Output File Name for sorted BED & CDT Files 
<div class="tutorial-img-flow-container">
  <img src={require('./img_atacseq/outputfile.png').default} style={{width:60+'%',}}/>
</div>
...
<div class="tutorial-img-flow-container">
  <img src={require('./img_atacseq/gui-heatmp.png').default} style={{width:40+'%',}}/>
  <i class="fa-solid fa-arrow-right fa-lg"></i>
  <img src={require('./img_atacseq/gui-heatmap-out.png').default} style={{width:40+'%',}}/>
</div>
